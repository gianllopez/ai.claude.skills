...
5. [Testing & Verification](#5-testing--verification) — `HIGH`
   - [5.1 Scoped Verification & No Unsolicited Tests](#51-scoped-verification--no-unsolicited-tests)
6. [Documentation & Style](#6-documentation--style) — `MEDIUM`
   - [6.1 Comment Language, Structure & Necessity](#61-comment-language-structure--necessity)
...
### 5.1 Scoped Verification & No Unsolicited Tests
...
### 6.1 Comment Language, Structure & Necessity
