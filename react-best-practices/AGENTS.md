...
1. [Component Architecture](#1-component-architecture) — `HIGH`
   ...
   - 1.3 [Composition Over Configuration](#13-composition-over-configuration)
   - 1.4 [Component Extraction Threshold](#14-component-extraction-threshold)
   - 1.5 [Component Typing Conventions](#15-component-typing-conventions)
   - 1.6 [Minimal Markup Depth](#16-minimal-markup-depth)
   - 1.7 [Syntax & Conciseness Conventions](#17-syntax--conciseness-conventions)
...
### 1.4 Component Extraction Threshold
...
### 1.5 Component Typing Conventions
...
### 1.7 Syntax & Conciseness Conventions
